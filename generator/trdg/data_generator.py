...
class FakeTextDataGenerator(object):
    ...
    def generate(
        ...
        if background_type == 0:
            ...
            background_img = background_generator.color_with_noise(
                background_height, background_width
            )
        else:
    ...
    #    print(name)
        if out_dir is not None:
            ...
            if output_bboxes == 1:
                ...
                with open(os.path.join(out_dir.split('/')[-3] + '/labels/' + mode, box_name), "w") as f:
                    for bbox in bboxes:
