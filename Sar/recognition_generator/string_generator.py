...
def create_strings_from_dict(
    length: int, allow_variable: bool, count: int, lang_dict: List[str], rub_dict: List[str], rub_ch: float,
        orientation: List[int], mesh_prob: float) -> List[str]:
    """
